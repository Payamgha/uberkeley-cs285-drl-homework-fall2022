...
## Further Study: 
1. Could we use self.parameters() instead of self.mean_net.parameters()?
2. How's the performance for discrete case? Are we trying to match logit for expert demonstrations?
3. How can we update `logstd` using expert demonstration?